...
$(ColorRed '------------------------------------------------------------')"
    echo ""
    tput setaf 2
    echo "You are about to INSTALL the Valheim Server"
    tput setaf 9
    tput setaf 2
...
$(ColorRed '------------------------------------------------------------')"
    ...
    if [ "$confirmStartInstall" == "y" ]; then
        ...
        tput setaf 1
        echo "Install Git, Locate, Curl, Unzip and Net-Tools"
        tput setaf 9
        ...
        #update system again
        tput setaf 1
        echo "Checking and updating system again"
        tput setaf 9
        apt update
        tput setaf 2
        echo "Done"
        ...
        while true; do
            ...
            tput setaf 9
            tput setaf 2
            echo "----------------NONROOT STEAM ACCOUNT PASSWORD--------------"
            tput setaf 9
            tput setaf 2
            echo "------------------------------------------------------------"
            tput setaf 9
        ...
        tput setaf 9
        tput setaf 2
        echo "------------------Public Server Display Name----------------"
        tput setaf 9
        tput setaf 2
        echo "------------------------------------------------------------"
        tput setaf 9
        ...
        tput setaf 9
        tput setaf 2
        echo "Good Example: Zero's Viking Server"
        tput setaf 9
        tput setaf 1
        echo "Bad Example: Zero's #1 Server Cash Signs hashtags or other special chars, it will break the script!"
        tput setaf 9
        tput setaf 2
        echo "------------------------------------------------------------"
        tput setaf 9
        ...
        while true; do
            ...
            tput setaf 9
            tput setaf 2
            echo "Good Example: ThorsHammer"
            tput setaf 9
            tput setaf 1
            echo "Bad Example: Loki is a Trickster"
            tput setaf 9
            tput setaf 2
            echo "------------------------------------------------------------"
            tput setaf 9
        ...
        tput setaf 9
        tput setaf 2
        echo "--------------------Set Server Access Password--------------"
        tput setaf 9
        tput setaf 2
        echo "------------------------------------------------------------"
        tput setaf 9
        ...
        tput setaf 9
        tput setaf 1
        echo "Server is required to have a password"
        tput setaf 9
        tput setaf 1
        echo "Password cannot match public display name or world name"
        tput setaf 9
        tput setaf 1
        ...
        tput setaf 9
        tput setaf 2
        echo "---------------------Public Server Shown--------------------"
        tput setaf 9
        tput setaf 2
        echo "------------------------------------------------------------"
        tput setaf 9
        tput setaf 1
        echo "Do you want your Server Shown Publicly"
        tput setaf 9
        tput setaf 2
        echo "------------------------------------------------------------"
        tput setaf 9
        tput setaf 2
        echo "Show Server in Public List: 1 "
        tput setaf 9
        tput setaf 1
        echo "Play Server on LAN or Not Listed Publicly: 0"
        tput setaf 9
        tput setaf 2
        echo "------------------------------------------------------------"
        tput setaf 9
...
EOF
        ...
        tput setaf 9
        tput setaf 2
        echo "Show Public Server: $publicList "
        tput setaf 9
        tput setaf 2
        echo "------------------------------------------------------------"
        tput setaf 9
        ...
        tput setaf 1
        echo "Installing steamcmd and libsdl2"
        tput setaf 9
        ...
        tput setaf 1
        echo "Building steam account NONROOT"
        tput setaf 9
        sleep 1
        ...
        tput setaf 1
        echo "Building symbolic link for steamcmd"
        tput setaf 9
        ...
        tput setaf 1
        echo "Setting steam permissions"
        tput setaf 9
        ...
        tput setaf 1
        echo "Deleting old configuration if file exist"
        tput setaf 9
        tput setaf 1
        echo "Building Valheim start_valheim server configuration"
        tput setaf 9
...
EOF
        ...
        tput setaf 1
        echo "Deleting old check log script if exist"
        tput setaf 9
        [ -e /home/steam/check_log.sh ] && rm /home/steam/check_log.sh
        #set execute permissions
        tput setaf 1
        echo "Setting execute permissions on start_valheim.sh"
        tput setaf 9
        ...
        tput setaf 9
        tput setaf 1
        echo "Setting execute permissions on check_log.sh"
        tput setaf 9
        ...
        tput setaf 9
        tput setaf 1
        echo "Building systemctl instructions for Valheim"
        tput setaf 9
...
EOF
        ...
        tput setaf 1
        echo "Setting steam account permissions to /home/steam/*"
        tput setaf 9
        chown steam:steam -Rf /home/steam/*
        tput setaf 2
        echo "Done"
        ...
        # Reload daemons
        tput setaf 1
        echo "Reloading daemons and spawning Necks"
        tput setaf 9
        ...
        # Start server
        tput setaf 1
        echo "By Thors Hammer we are Starting the Valheim Server"
        tput setaf 9
        ...
        tput setaf 1
        echo "Enabling Valheim Server on start or after reboots"
        tput setaf 9
        ...
        clear
        tput setaf 2
        echo "Check server status by typing systemctl status valheimserver.service"
        tput setaf 2
        echo "Thank you for using the script."
        tput setaf 2
        echo "AND A HUGE THANKS TO github: @Lachlanmac, @JamieeLee, @RedKrieg, @bherbruck "
        tput setaf 2
        echo "@xaviablaza, @joaoanes, @amasover, @madmozg, @nicolas-martin, @devdavi and others!"
        tput setaf 2
        echo "If your name is missing! Let me know!"
        tput setaf 2
        echo "-ZeroBandwidth"
        tput setaf 2
        echo "GLHF"
...
function backup_world_data() {
    ...
    if [ "$confirmBackup" == "y" ]; then
        ...
        tput setaf 9
        tput setaf 2
        echo "Valheim Services successfully Stopped"
        tput setaf 9
        tput setaf 2
        echo "Waiting for 10 seconds for Valheim to finish off loading RAM to world data files"
        tput setaf 9
        #give it a few
        sleep 10
        tput setaf 1
...
function restore_world_data() {
    ...
    tput setaf 9
    tput setaf 2
    echo "To CANCEL select any file. Next are you can confirm or back out"
    tput setaf 9
...
$(ColorRed '------------------------------------------------------------')"
    echo ""
    tput setaf 2
    echo "A NEW update was found!"
    tput setaf 9
    tput setaf 2
    echo "You are about to apply Official Valheim Updates"
    tput setaf 9
    tput setaf 2
    echo "You are you sure y(YES) or n(NO)?"
    tput setaf 9
...
$(ColorRed '------------------------------------------------------------')"
        echo ""
        tput setaf 2
        echo "The Script will download the Log Data from the official"
        tput setaf 9
        tput setaf 2
        echo "Steam Valheim Repo and compare the data."
        tput setaf 9
        tput setaf 2
        echo "No changes will be made, until you agree later."
        tput setaf 9
        tput setaf 2
...
function write_config_and_restart() {
    tput setaf 1
    echo "Rebuilding Valheim start_valheim.sh configuration file"
    tput setaf 9
    sleep 1
    cat >${valheimInstallPath}/start_valheim.sh <<EOF
#!/bin/bash
...
function change_public_display_name() {
    ...
    tput setaf 9
    tput setaf 2
    echo "------------------Set New Public Display Name---------------"
    tput setaf 9
    tput setaf 2
    echo "------------------------------------------------------------"
    tput setaf 9
    ...
    tput setaf 9
    tput setaf 1
    echo "The Server is required to have a public display name"
    tput setaf 9
    tput setaf 1
    ...
    tput setaf 9
    tput setaf 2
    echo "Current Public Display Name: ${currentDisplayName}"
    tput setaf 9
    tput setaf 2
    echo "------------------------------------------------------------"
    tput setaf 9
    ...
    echo ""
    tput setaf 5
    echo "Old Public Display Name: " ${currentDisplayName}
    tput setaf 9
    tput setaf 2
    echo "------------------------------------------------------------"
    tput setaf 9
    echo ""
    tput setaf 1
    echo "New Public Display Name:" ${setCurrentDisplayName}
    tput setaf 9
    echo ""
    tput setaf 2
    echo "------------------------------------------------------------"
...
function change_default_server_port() {
    ...
    tput setaf 9
    tput setaf 1
    echo "The Server is required to have a port to operate on"
    tput setaf 9
    tput setaf 1
    echo "Do not use SPECIAL characters:"
    tput setaf 9
    tput setaf 1
    echo "New assigned port must be greater than 3000:"
    tput setaf 9
    tput setaf 2
    echo "------------------------------------------------------------"
    tput setaf 9
    tput setaf 2
    echo "Current Server Port: ${currentPort} "
    tput setaf 9
    tput setaf 2
    echo "------------------------------------------------------------"
    tput setaf 9
    ...
    tput setaf 9
    tput setaf 5
    echo "Old Server Port: " ${currentPort}
    tput setaf 9
    tput setaf 6
    echo "New Server Port: " ${setCurrentPort}
    tput setaf 9
    tput setaf 2
    echo "------------------------------------------------------------"
    tput setaf 9
...
function change_server_access_password() {
    ...
    tput setaf 9
    tput setaf 2
    echo "---------------Set New Server Access Password---------------"
    tput setaf 9
    tput setaf 2
    echo "------------------------------------------------------------"
    tput setaf 9
    ...
    tput setaf 9
    tput setaf 1
    echo "Valheim requires a UNIQUE password 6 characaters or longer"
    tput setaf 9
    tput setaf 1
    echo "UNIQUE means Password can not match Public and World Names"
    tput setaf 9
    tput setaf 1
    echo "Do not use SPECIAL characters:"
    tput setaf 9
    ...
    tput setaf 9
    tput setaf 5
    echo "Current World Name:" ${currentWorldName}
    tput setaf 9
    tput setaf 2
    echo "------------------------------------------------------------"
    tput setaf 9
    tput setaf 2
    echo "Current Access Password: ${currentPassword} "
    tput setaf 9
    tput setaf 2
    echo "------------------------------------------------------------"
    tput setaf 9
    ...
    echo ""
    tput setaf 5
    echo "Old Server Access Password:" ${currentPassword}
    tput setaf 9
    tput setaf 5
    echo "New Server Access Password:" ${setCurrentPassword}
    tput setaf 9
...
function display_public_IP() {
    ...
    echo -e '\E[32m'"External IP : $whateverzerowantstocalthis "$externalip
    tput setaf 9
}

function display_local_IP() {
    internalip=$(hostname -I)
    echo -e '\E[32m'"Internal IP :" $mymommyboughtmeaputerforchristmas $internalip
    tput setaf 9
